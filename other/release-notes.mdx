...
- **1.3.10**
  - Added browser integration features:
    - CMD+L support for Chrome, Firefox, Arc, and Safari
    - Add entire web pages to context
    - Text selection support for Chrome and Arc
  - Improved Cmd+K functionality:
    - Added model selection (Claude 3.5 Sonnet, GPT-4o, Gemini Flash 2.0)
    - Added retry generation option
  - Added Gemini Flash 2.0:
    - Available in Chat
    - Available in Cmd+K
  - Added image support:
    - Copy-paste images into chat
  - Fixed code apply functionality issues
