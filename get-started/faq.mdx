...
Open the App, then Go to settings (top right button), then click Billing, and click "Manage / Cancel Subscription". If you've canceled already or your payment has failed, the button will not appear.
