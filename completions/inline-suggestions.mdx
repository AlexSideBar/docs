...
description: "Learn how to use Alex Sidebar's code completion features"
---
...
<Frame>
  <img 
    src="/images/tab-completion.png" 
    alt="Real-time code completion in action showing suggestions as you type"
  />
</Frame>
...
3. Toggle "Enable Autocomplete"

<Note>
  For the best experience of developing with Alex Sidebar and Xcode, ensure autocomplete is enabled. This provides real-time suggestions as you type without needing to trigger completions manually.
</Note>
