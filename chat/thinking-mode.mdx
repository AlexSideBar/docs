...
![Alex Sidebar showing the AI's thought process in real-time.](/images/think-mode-demo.png)

## Overview

The Thought Process feature shows the AI's reasoning in real-time as it works through your requests. Unlike a simple response, you can see the AI's internal dialogue - how it analyzes problems, considers different approaches, and even corrects itself. This transparency helps you understand exactly how the AI arrives at its solutions.

## How It Works

The thought process is always visible for supported models. As the AI processes your request, you'll see its reasoning appear in real-time, including:
...
Thought process visibility varies by model:
...
When using a model that shows thinking:
- The thought process appears in a dedicated section
...
<Note>
The thought process is automatically shown for all supported models. There's no need to enable or toggle this feature - it's always active to provide maximum transparency.
</Note>
...
<Steps>
  <Step title="Real-Time Updates">
    The thought process appears as the AI works, not after it's done thinking
  </Step>
...
<Info>
  Models that show their thought process may take slightly longer to respond as they work through problems systematically. This deeper analysis often leads to more accurate and well-reasoned solutions.
</Info>

<Tip>
  The thought process is particularly valuable for:
