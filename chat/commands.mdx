...
<CardGroup cols={2}>
  <Card title="Files" icon="folder" href="#files-command">
...
## Files Command
Access your project files directly within the chat interface. Browse, search, and reference specific files or directories during your conversations.
...
Access and reference specific documentation entries, methods, or APIs for precise technical discussions.

<Frame>
      <img
        src="/images/individual-docs-command.png"
        alt="Individual Apple Documentation command interface showing specific documentation entries"
      />
</Frame>
