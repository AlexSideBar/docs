...
Perfect for getting second opinions or using models with larger context windows.
...
<video
  ...
  loop
  playsInline
  src="/videos/copy-request.mp4"
  alt="Demonstration of using Copy Request button to export chat context"
  title="Copy Request Button Demo"
></video>

The Copy Request button lets you export your entire conversation to use with external AI services:
...
<Steps>
  ...
  <Step title="Click to Copy">
    Clicking copies your entire conversation including:
  ...
  <Step title="Use with Any AI Service">
    ...
    - **ChatGPT o3-pro** - For complex reasoning tasks
    - **Google AI Studio** - Access Gemini Pro 2.5 with 1M+ token context
    - **Claude.ai** - Alternative analysis with Claude models
  </Step>
</Steps>

<Tip>
  Use this feature when you need:
  - A larger context window than available locally
  - Second opinions from different AI models
  - To share conversations with team members
</Tip>
