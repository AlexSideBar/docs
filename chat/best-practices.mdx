...
<Note>
  ✅ **Feature Request**: `I need to implement a custom tab bar in SwiftUI that shows a circular progress indicator around the selected tab icon. The progress should be animated and support both light and dark mode. Here's my current TabView implementation...`
</Note>
...
<CardGroup cols={2}>
  <Card title="Context Management" icon="clock-rotate-left">
    - Use history for reference
    - Clear context when needed
    - Save important conversations
  </Card>

  <Card title="Performance" icon="tachometer">
    - Use Fast Apply for quick changes
    - Use Slow Apply for complex tasks
