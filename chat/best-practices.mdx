...
- Toggle with **Command + T** or use the **Think** button
- Note that some models (Gemini 2.5 Pro, DeepSeek R1) have mandatory think mode

<Note>
  For detailed information about Think Mode, including supported models and activation methods, see our [Think Mode guide](/chat/thinking-mode).
</Note>
