...
<Frame>
  <img
    src="/images/team-members-dashboard.png"
    alt="Team Members dashboard showing member list and invite options"
  />
</Frame>
...
<Frame>
  <img
    src="/images/team-models-overview.png"
    alt="Team Models configuration page showing various model types"
  />
</Frame>
...
#### 1. Chat Models
Main conversational AI for code discussions and assistance.

<Frame>
  <img
    src="/images/team-chat-models-config.png"
    alt="Chat Models configuration showing Base URL, API Key, and Model Name fields"
  />
</Frame>
...
<Frame>
  <img
    src="/images/team-autocomplete-model.png"
    alt="Autocomplete Model configuration"
  />
</Frame>

#### 3. Thinking Model
Models with reasoning capabilities for complex problem-solving.

<Frame>
  <img
    src="/images/team-thinking-model.png"
    alt="Thinking Model configuration"
  />
</Frame>

#### 4. Voice Model
Speech-to-text processing for voice commands.

<Frame>
  <img
    src="/images/team-voice-model.png"
    alt="Voice Model configuration"
  />
</Frame>
...
<Frame>
  <img
    src="/images/team-embedding-model.png"
    alt="Embedding Model configuration"
  />
</Frame>

#### 6. Code-Apply Model
Direct code modifications and refactoring.

<Frame>
  <img
    src="/images/team-code-apply-model.png"
    alt="Code-Apply Model configuration"
  />
</Frame>

#### 7. Web Model
Web search integration for documentation and answers.

<Frame>
  <img
    src="/images/team-web-model.png"
    alt="Web Model configuration"
  />
</Frame>
...
<Frame>
  <img
    src="/images/team-image-model.png"
    alt="Image Model configuration"
  />
</Frame>

#### 9. Summarizer Model
Document and code summarization.

<Frame>
  <img
    src="/images/team-summarizer-model.png"
    alt="Summarizer Model configuration"
  />
</Frame>
...
<Frame>
  <img
    src="/images/team-multiple-models.png"
    alt="Multiple chat models configured for different environments"
  />
</Frame>
...
<Frame>
  <img
    src="/images/team-advanced-settings.png"
    alt="Advanced Settings tab showing telemetry toggle"
  />
</Frame>
