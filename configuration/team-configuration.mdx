...
<Frame>
  <img
    src="/images/different-models-overview.png"
...
<Frame>
  <img
    src="/images/team-models-in-sidebar.png"
    alt="Alex Sidebar showing custom team models in the model selector"
  />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Can't access admin portal">
    ...
    - Contact team@alexcodes.app if you need admin access
  </Accordion>
</AccordionGroup>
