...
<CardGroup cols={2}>
  ...
  <Card title="DeepSeek V3" icon="rocket">
    The latest update to DeepSeek's V3 model is optimized for speed and efficiency.
    
    Perfect for rapid development in large files.
  </Card>
