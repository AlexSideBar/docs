    ...
    model_list:
      ...
      - model_name: "claude-4-sonnet-reasoning"
        litellm_params:
          model: "bedrock/anthropic.claude-4-sonnet-20250514-v1:0"
          aws_region_name: "us-east-1"
          thinking: true  # Enable reasoning capabilities
...
health_check:
  ...
  models_to_check: ["claude-4-sonnet", "gemini-2.5-pro"]
```
...
model_list:
  - model_name: "best-reasoning"
    litellm_params:
      model: "o3-pro"  # OpenAI's latest reasoning model
      reasoning_effort: "high"
